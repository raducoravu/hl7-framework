...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CapabilityStatement">
      ...
      <sch:assert test="not(f:kind/@value='requirements' and (f:implementation | f:software))">cpb-16: If kind = requirements, implementation and software must be absent</sch:assert>
